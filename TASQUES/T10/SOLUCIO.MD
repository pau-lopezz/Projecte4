...
Per aquest motiu, haurem de tornar a la terminal i afegir l’usuari inicial al grup lpadmin, que és el grup amb permisos d’administració de CUPS. 
```bash
...
![Status](https://img.shields.io/badge/Estat-Complet-success)
